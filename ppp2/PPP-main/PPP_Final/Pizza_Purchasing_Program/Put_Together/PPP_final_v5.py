...
while order_again == "yes":
    ...
    collect = string_check(f"Would you like to pick up your order or have it delivered to you? Delivery orders cost"
    ...
    pay_method = string_check(f"Your order costs ${price:.2f}. Will you be paying with cash or credit? ",
                              payment_ans, 2)
